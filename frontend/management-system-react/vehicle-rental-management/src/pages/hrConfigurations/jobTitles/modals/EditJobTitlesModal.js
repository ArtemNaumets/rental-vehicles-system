...
const EditJobTitlesModal = ({ show, onClose, onSave, selectedItem, fields }) => {
    ...
    const saveEditedFields = async () => {
        ...
        try {
            await HrService.updateJobTitle(selectedItem.id, editedFields);
            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title">Edit JobTitle</h5>
