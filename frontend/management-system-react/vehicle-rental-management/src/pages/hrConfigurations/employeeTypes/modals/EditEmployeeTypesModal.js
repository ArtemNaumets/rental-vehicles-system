...
const EditEmployeeTypesModal = ({ show, onClose, onSave, selectedItem, fields }) => {
    ...
    const saveEditedFields = async () => {
        ...
        try {
            await HrService.updateEmployeeType(selectedItem.id, editedFields);
            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title">Edit EmployeeType</h5>
...
export default EditEmployeeTypesModal;
