  ...
  const DeleteEmployeeTypesModal = ({ show, onClose, onDelete, selectedItem }) => {
      ...
      const deleteItem = async () => {
          ...
          setErrorMessage('');
          try {
              await HrService.deleteEmployeeType(selectedItem.id); 
  ...
  export default DeleteEmployeeTypesModal;
