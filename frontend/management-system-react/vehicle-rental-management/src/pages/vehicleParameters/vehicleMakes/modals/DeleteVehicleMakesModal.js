  ...
  const DeleteVehicleMakesModal = ({ show, onClose, onDelete, selectedItem }) => {
      ...
      const deleteItem = async () => {
          ...
          setErrorMessage('');
          try {
              await VehicleParameterService.deleteVehicleMake(selectedItem.id); 
  ...
  export default DeleteVehicleMakesModal;
