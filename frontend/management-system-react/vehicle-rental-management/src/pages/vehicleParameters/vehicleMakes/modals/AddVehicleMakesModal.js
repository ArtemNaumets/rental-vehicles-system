...
const AddVehicleMakesModal = ({ show, onClose, onAdd, fields }) => {
    ...
    const addNewData = async () => {
        ...
        setLoading(true);
        try {
            await VehicleParameterService.saveVehicleMake(newData); 
            onClose();
            setNewData({});
            onAdd();
            setErrorMessage('');
            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title">Add New VehicleMake</h5>
...
export default AddVehicleMakesModal;
