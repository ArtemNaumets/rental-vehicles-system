const DetailsVehicleStatusesModal = ({ show, onClose, selectedItem, fields }) => {
            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title">Details VehicleStatus</h5>
...
export default DetailsVehicleStatusesModal;
