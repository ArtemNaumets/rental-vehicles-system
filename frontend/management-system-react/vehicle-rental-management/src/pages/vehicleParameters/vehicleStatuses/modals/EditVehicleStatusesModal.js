...
const EditVehicleStatusesModal = ({ show, onClose, onSave, selectedItem, fields }) => {
    ...
    const saveEditedFields = async () => {
        ...
        try {
            await VehicleParameterService.updateVehicleStatus(selectedItem.id, editedFields);
            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title">Edit VehicleStatus</h5>
...
export default EditVehicleStatusesModal;
