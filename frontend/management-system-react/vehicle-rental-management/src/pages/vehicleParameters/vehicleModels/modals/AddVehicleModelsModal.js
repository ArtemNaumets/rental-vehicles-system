...
const AddVehicleModelsModal = ({ show, onClose, onAdd, fields }) => {
    ...
    const addNewData = async () => {
        ...
        setLoading(true);
        try {
            await VehicleParameterService.saveVehicleModel(newData); 
            onClose();
            setNewData({});
            onAdd();
            setErrorMessage('');
            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title">Add New VehicleModel</h5>
...
export default AddVehicleModelsModal;
