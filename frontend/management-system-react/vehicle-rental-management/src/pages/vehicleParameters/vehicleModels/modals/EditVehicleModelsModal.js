...
const EditVehicleModelsModal = ({ show, onClose, onSave, selectedItem, fields }) => {
    ...
    const saveEditedFields = async () => {
        ...
        try {
            await VehicleParameterService.updateVehicleModel(selectedItem.id, editedFields);
            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title">Edit VehicleModel</h5>
...
export default EditVehicleModelsModal;
