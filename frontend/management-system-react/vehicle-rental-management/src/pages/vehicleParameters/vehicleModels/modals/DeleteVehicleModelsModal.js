  ...
  const DeleteVehicleModelsModal = ({ show, onClose, onDelete, selectedItem }) => {
      ...
      const deleteItem = async () => {
          ...
          setErrorMessage('');
          try {
              await VehicleParameterService.deleteVehicleModel(selectedItem.id); 
  ...
  export default DeleteVehicleModelsModal;
