const DetailsVehicleModelsModal = ({ show, onClose, selectedItem, fields }) => {
            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title">Details VehicleModel</h5>
...
export default DetailsVehicleModelsModal;
