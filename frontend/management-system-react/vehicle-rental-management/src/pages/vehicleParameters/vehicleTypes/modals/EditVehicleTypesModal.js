...
const EditVehicleTypesModal = ({ show, onClose, onSave, selectedItem, fields }) => {
    ...
    const saveEditedFields = async () => {
        ...
        try {
            await VehicleParameterService.updateVehicleType(selectedItem.id, editedFields);
            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title">Edit VehicleType</h5>
...
export default EditVehicleTypesModal;
