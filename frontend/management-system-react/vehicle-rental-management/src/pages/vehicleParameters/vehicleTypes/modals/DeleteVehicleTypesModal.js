  ...
  const DeleteVehicleTypesModal = ({ show, onClose, onDelete, selectedItem }) => {
      ...
      const deleteItem = async () => {
          ...
          setErrorMessage('');
          try {
              await VehicleParameterService.deleteVehicleType(selectedItem.id); 
  ...
  export default DeleteVehicleTypesModal;
