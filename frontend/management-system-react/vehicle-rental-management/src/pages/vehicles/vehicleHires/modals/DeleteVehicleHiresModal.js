  ...
  const DeleteVehicleHiresModal = ({ show, onClose, onDelete, selectedItem }) => {
      ...
      const deleteItem = async () => {
          ...
          setErrorMessage('');
          try {
              await VehicleService.deleteVehicleHire(selectedItem.id); 
  ...
  export default DeleteVehicleHiresModal;
