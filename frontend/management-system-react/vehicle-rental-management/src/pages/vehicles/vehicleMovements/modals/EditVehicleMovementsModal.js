...
const EditVehicleMovementsModal = ({ show, onClose, onSave, selectedItem, fields }) => {
    ...
    useEffect(() => {
        if (selectedItem) {
            const { vehicleName, location1Description, location2Description, vehicle, ...rest } = selectedItem; 
    ...
    const saveEditedFields = async () => {
        ...
        try {
            await VehicleService.updateVehicleMovement(selectedItem.id, editedFields);
            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title">Edit Vehicle Movement</h5>
...
export default EditVehicleMovementsModal;
