...
const AddVehicleMovementsModal = ({ show, onClose, onAdd, fields }) => {
    ...
    const addNewData = async () => {
        ...
        setLoading(true);
        try {
            await VehicleService.saveVehicleMovement(newData); 
            onClose();
            setNewData({});
            onAdd();
            setErrorMessage('');
    ...
    const renderInput = (field) => {
        ...
        } else if (key.toLowerCase() === 'locationid1' || key.toLowerCase() === 'locationid2') {
            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title">Add New Vehicle Movement</h5>
...
export default AddVehicleMovementsModal;
