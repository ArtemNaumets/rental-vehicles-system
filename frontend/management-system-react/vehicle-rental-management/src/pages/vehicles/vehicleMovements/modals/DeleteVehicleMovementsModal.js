  ...
  const DeleteVehicleMovementsModal = ({ show, onClose, onDelete, selectedItem }) => {
      ...
      const deleteItem = async () => {
          ...
          setErrorMessage('');
          try {
              await VehicleService.deleteVehicleMovement(selectedItem.id); 
  ...
  export default DeleteVehicleMovementsModal;
