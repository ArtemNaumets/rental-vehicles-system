  ...
  const DeleteVehicleMaintenancesModal = ({ show, onClose, onDelete, selectedItem }) => {
      ...
      const deleteItem = async () => {
          ...
          setErrorMessage('');
          try {
              await VehicleService.deleteVehicleMaintenance(selectedItem.id); 
  ...
  export default DeleteVehicleMaintenancesModal;
