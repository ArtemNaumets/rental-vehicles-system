...
const AddVehicleMaintenancesModal = ({ show, onClose, onAdd, fields }) => {
    ...
    const addNewData = async () => {
        ...
        setLoading(true);
        try {
            await VehicleService.saveVehicleMaintenance(newData); 
            onClose();
            setNewData({});
            onAdd();
            setErrorMessage('');
    ...
    const renderInput = (field) => {
        ...
        } else if (key.toLowerCase() === 'supplierid') {
            ...
            <div className="modal-dialog" role="document">
                <div className="modal-content">
                    <div className="modal-header">
                        <h5 className="modal-title">Add New Vehicle Maintenance</h5>
...
export default AddVehicleMaintenancesModal;
