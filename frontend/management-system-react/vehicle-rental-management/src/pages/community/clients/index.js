...
import { getClients } from '../../../api/CommunityService'; 

import { predefinedFields } from '../../../configs/fieldsConfig'; 
import { API_URLS } from '../../../configs/apiConfig';
import AddClientsModal from './modals/AddClientsModal';
import DetailsClientsModal from './modals/DetailsClientsModal';
...
const ClientsPage = () => {
    ...
    const fields = predefinedFields[API_URLS.clients] || [];
        ...
        <div className="container-fluid">
            <div className="row">
                <div className="col-md-12">
                    ...
                    <button className="btn btn-primary mb-3" onClick={() => setShowAddModal(true)}>Add New Client</button>
